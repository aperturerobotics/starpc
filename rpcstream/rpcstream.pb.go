...
func (m *RpcStreamPacket) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *RpcStreamInit) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (m *RpcAck) CloneMessageVT() any {
	return m.CloneVT()
}
...
func (x *RpcStreamInit) MarshalProtoJSON(s *json.MarshalState) {
	...
	s.WriteObjectStart()
	var wroteField bool
	if x.ComponentId != "" || s.HasField("component_id") {
		s.WriteMoreIf(&wroteField)
		s.WriteObjectField("component_id")
...
func (m *RpcStreamPacket) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return errors.Errorf("proto: RpcStreamPacket: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: RpcStreamPacket: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RpcStreamInit) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: RpcStreamInit: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: RpcStreamInit: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return errors.Errorf("proto: wrong wireType = %d for field ComponentId", wireType)
			}
...
func (m *RpcAck) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return errors.Errorf("proto: RpcAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return errors.Errorf("proto: RpcAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
