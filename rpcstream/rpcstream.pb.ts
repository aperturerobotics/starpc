...
export interface RpcStreamPacket {
  body?: { $case: "init"; init: RpcStreamInit } | { $case: "ack"; ack: RpcAck } | { $case: "data"; data: Uint8Array };
}
...
export const RpcStreamPacket = {
  encode(message: RpcStreamPacket, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<RpcStreamPacket | RpcStreamPacket[]> | Iterable<RpcStreamPacket | RpcStreamPacket[]>,
  ...
  fromPartial<I extends Exact<DeepPartial<RpcStreamPacket>, I>>(object: I): RpcStreamPacket {
    const message = createBaseRpcStreamPacket();
...
export const RpcStreamInit = {
  encode(message: RpcStreamInit, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  async *encodeTransform(
    source: AsyncIterable<RpcStreamInit | RpcStreamInit[]> | Iterable<RpcStreamInit | RpcStreamInit[]>,
  ): AsyncIterable<Uint8Array> {
    for await (const pkt of source) {
      if (Array.isArray(pkt)) {
        for (const p of pkt) {
  ...
  fromPartial<I extends Exact<DeepPartial<RpcStreamInit>, I>>(object: I): RpcStreamInit {
    const message = createBaseRpcStreamInit();
...
export const RpcAck = {
  encode(message: RpcAck, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.error !== "") {
