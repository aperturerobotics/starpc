...
var file_github_com_aperturerobotics_starpc_echo_echo_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x96, 0x01, 0x0a, 0x06, 0x45, 0x63,
...
var file_github_com_aperturerobotics_starpc_echo_echo_proto_depIdxs = []int32{
	...
	0, // 3: echo.Echoer.Echo:output_type -> echo.EchoMsg
	0, // 4: echo.Echoer.EchoServerStream:output_type -> echo.EchoMsg
	0, // 5: echo.Echoer.EchoClientStream:output_type -> echo.EchoMsg
