...
// protoc-gen-starpc-cpp version: v0.52.2-0.20260903015026-8f335488f9dc+dirty
...
class SRPCEchoer_EchoServerStreamClient {
 public:
  ...
  std::stop_token StopToken() const { return strm_->StopToken(); }
  std::string RemoteErrorMessage() const { return strm_->RemoteErrorMessage(); }
